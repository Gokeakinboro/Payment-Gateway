...
const MODULES = [
  ...
  { name: 'nibss-webhook',     basePath: '/api/v1/webhooks/nibss',     load: () => require('./gateway-core/routes/nibss-webhook'),     enabledEnv: 'MODULE_NIBSS_WEBHOOK_ENABLED',    category: 'money' },
