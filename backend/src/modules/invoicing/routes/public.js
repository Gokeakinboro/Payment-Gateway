  ...
  try {
    const rows = await prisma.$queryRawUnsafe(
      `SELECT i.id::text, i.invoice_number, i.description, i.amount::text AS amount,
              ...
              i.due_at, i.recipient_name, i.line_items, m.business_name, f.logo_url, f.address, f.business_email, f.business_phone, f.layout
    ...
    return ok(res, {
      ...
      line_items: Array.isArray(r.line_items) ? r.line_items : null,
